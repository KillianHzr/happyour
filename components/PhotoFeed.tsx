...
export default function PhotoFeed({ photos, currentUserId, nextUnlockDate, crownWinnerId, crownDurationMs = 0, groupName, onScrollLock, onActiveIndexChange, onOpenPicker }: Props) {
  const insets = useSafeAreaInsets();
